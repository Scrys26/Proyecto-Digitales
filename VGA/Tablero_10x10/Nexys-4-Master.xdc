...
# Reloj real de la placa = 100 MHz => periodo 10.000 ns
...
set_property PACKAGE_PIN V10 [get_ports btnC]
...
#set_property PACKAGE_PIN B13 [get_ports {tx_out}]
#set_property IOSTANDARD LVCMOS33 [get_ports {tx_out}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,                   Sch name = JA2
#set_property PACKAGE_PIN F14 [get_ports {ready_rx}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ready_rx}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,                   Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {buzzer}]
#set_property IOSTANDARD LVCMOS33 [get_ports {buzzer}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,                   Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports {ready_rx_out}]
#set_property IOSTANDARD LVCMOS33 [get_ports {ready_rx_out}]
##Bank = 15, Pin name = IO_0_15,                             Sch name = JA7
# Desactivado para evitar conflicto con USB-UART
# set_property PACKAGE_PIN G13 [get_ports {RsRx}]
...
##USB-RS232 Interface (USB-UART FTDI)
##Bank = 35, Pin name = IO_L7P_T1_AD6P_35,                   Sch name = UART_TXD_IN (PC->FPGA)
set_property PACKAGE_PIN C4 [get_ports uart_rx]
set_property IOSTANDARD LVCMOS33 [get_ports uart_rx]
##Bank = 35, Pin name = IO_L11N_T1_SRCC_35,                  Sch name = UART_RXD_OUT (FPGA->PC)
set_property PACKAGE_PIN D4 [get_ports uart_tx]
set_property IOSTANDARD LVCMOS33 [get_ports uart_tx]
##Bank = 35, Pin name = IO_L12N_T1_MRCC_35,                  Sch name = UART_CTS
# (Opcional) Comentado para evitar requerir puertos extra
